...
<body>
   ...
   <center>
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    <th align="left" > Gender <span style="color: red"  size="25" >*</span> :</th>
                    <td>
                        <%
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="text" name="dob" placeholder="Enter Date Of Birth" size= "25" style="width:210px" readonly="readonly" id="udatee" value="<%=DataUtility.getDateString(bean.getDob())%>"></td>
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="text" style="width:210px" name="mobileNo"  placeholder="Enter Mobile No"  value="<%=DataUtility.getStringData(bean.getMobileNo())%>"></td>
